...
.controller('StepOneController', ['$scope','$location','$timeout', function($scope, $location, $timeout){
   ...
   $scope.next = function(){
        ...
        if($scope.subject === "di" || $scope.subject === "vi" || $scope.subject === "su" || $scope.subject === "ot"){
